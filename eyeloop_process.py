...
class EyeLoop:
    ...
    def __init__(self, args, extractors = None, logger=None):
    ...
    def run(self):
        ...
        extractors = self.extractors + extractors_add + extractors_base
...
def run_eyeloop_process(extractor):
    EyeLoop(sys.argv[1:], extractors=[extractor], logger=None)
